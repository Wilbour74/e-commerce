 ...
 */
final class Version20230810142009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP FOREIGN KEY FK_article');
        $this->addSql('ALTER TABLE panier DROP FOREIGN KEY panier_ibfk_1');
        $this->addSql('DROP INDEX FK_article ON panier');
        $this->addSql('DROP INDEX id_client ON panier');
        $this->addSql('ALTER TABLE panier CHANGE id_article id_article INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier CHANGE id_article id_article INT DEFAULT NULL');
        $this->addSql('ALTER TABLE panier ADD CONSTRAINT FK_article FOREIGN KEY (id_article) REFERENCES article (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        $this->addSql('CREATE INDEX FK_article ON panier (id_article)');
