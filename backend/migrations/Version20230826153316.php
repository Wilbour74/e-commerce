 ...
 */
final class Version20230826153316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD poids DOUBLE PRECISION NOT NULL, DROP Rabais_Pct, DROP date_add');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD Rabais_Pct INT DEFAULT 0, ADD date_add DATE DEFAULT NULL, DROP poids');
